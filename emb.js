new(function() {
        ...
        switch (typeof b) {
            ...
            case "object":
                ...
                if (p(b)) {
                    var d = b.length;
                    c.push("[");
                    for (var e = "", g = 0; g < d; g++) c.push(e), e = b[g], qa(a, a.Ua ? a.Ua.call(b, String(g), e) : e, c), e = ",";
                    c.push("]");
                    break
                }
                c.push("{");
    ...
    function Ha(a, b) {
        for (var c = 0, d = ya(String(a)).split("."), e = ya(String(b)).split("."), g = Math.max(d.length, e.length), h = 0; 0 == c && h < g; h++) {
            var k = d[h] || "",
                x = e[h] || "",
                Pd = RegExp("(\\d*)(\\D*)", "g"),
                Qd = RegExp("(\\d*)(\\D*)", "g");
            do {
                var oa = Pd.exec(k) || ["", "", ""],
                    pa = Qd.exec(x) || ["", "", ""];
                if (0 == oa[0].length && 0 == pa[0].length) break;
                c = Ia(0 == oa[1].length ? 0 : parseInt(oa[1], 10), 0 == pa[1].length ? 0 : parseInt(pa[1], 10)) || Ia(0 == oa[2].length, 0 == pa[2].length) || Ia(oa[2], pa[2])
            } while (0 == c)
        }
        return c
    }
    ...
    var v = Array.prototype,
        Na = v.indexOf ? function(a, b, c) { return v.indexOf.call(a, b, c) } : function(a, b, c) {
    ...
    a: {
        var $a = l.navigator;
        if ($a) { var ab = $a.userAgent; if (ab) { w = ab; break a } }
        w = ""
    }
    ...
    function nb(a, b, c) {
        if ("function" == typeof a.forEach) a.forEach(b, c);
            ...
            for (var e = mb(a), g = e.length, h = 0; h < g; h++) b.call(c, e[h], d && d[h], a)
        }
    };
    ...
    function ob(a, b) {
        ...
        if (1 < c) { if (c % 2) throw Error("Uneven number of arguments"); for (var d = 0; d < c; d += 2) this.set(arguments[d], arguments[d + 1]) } else if (a) { a instanceof ob ? (c = a.U(), d = a.N()) : (c = Wa(a), d = Va(a)); for (var e = 0; e < c.length; e++) this.set(c[e], d[e]) }
    }
    f = ob.prototype;
    ...
    function pb(a) {
        ...
        if (a.k != a.j.length) {
            for (var e = {}, c = b = 0; b < a.j.length;) d = a.j[b], qb(e, d) || (a.j[c++] = d, e[d] = 1), b++;
            a.j.length = c
        }
    }
    f.get = function(a, b) { return qb(this.u, a) ? this.u[a] : b };
    f.set = function(a, b) {
        qb(this.u, a) || (this.k++, this.j.push(a));
        this.u[a] = b
    };
    ...
    function Cb(a) {
        if (a.ca) return a.ca;
        if (a.Ra) return Cb(a.Ra);
        Ma("Root logger has no level set.");
        return null
    }
    f.log = function(a, b, c) {
        if (a.value >= Cb(this).value)
            for (ea(b) && (b = b()), a = new sb(a, String(b), this.kc), c && (a.mb = c), c = "log:" + a.jc, l.console && (l.console.timeStamp ? l.console.timeStamp(c) : l.console.markTimeline && l.console.markTimeline(c)), l.msWriteProfilerMark && l.msWriteProfilerMark(c), c = this; c;) {
                b = c;
                var d = a;
                if (b.ya)
    ...
    function G() {
        0 != Gb && (Hb[this[ga] || (this[ga] = ++ha)] = this);
        this.Y = this.Y;
        this.ea = this.ea
    }
    var Gb = 0,
    ...
    G.prototype.Ob = function() {
        if (!this.Y && (this.Y = !0, this.m(), 0 != Gb)) {
    ...
    H.prototype.add = function(a, b, c, d, e) {
        var g = a.toString();
        a = this.n[g];
        a || (a = this.n[g] = [], this.Ea++);
        var h = Nb(a, b, d, e); - 1 < h ? (b = a[h], c || (b.Ha = !1)) : (b = new Lb(b, this.src, g, !!d, e), b.Ha = c, a.push(b));
        return b
    };
    H.prototype.remove = function(a, b, c, d) {
        a = a.toString();
        if (!(a in this.n)) return !1;
        var e = this.n[a];
        b = Nb(e, b, c, d);
    ...
    function Ob(a, b) {
        var c = b.type;
        if (!(c in a.n)) return !1;
        var d = a.n[c],
            e = Na(d, b),
            g;
        (g = 0 <= e) && v.splice.call(d, e, 1);
        g && (Mb(b), 0 == a.n[c].length && (delete a.n[c], a.Ea--));
        return g
    }
    H.prototype.Ba = function(a) {
        ...
        for (c in this.n)
            if (!a || c == a) {
                for (var d = this.n[c], e = 0; e < d.length; e++) ++b, Mb(d[e]);
                delete this.n[c];
                this.Ea--
            }
        return b
    };
    H.prototype.xa = function(a, b, c, d) {
        a = this.n[a.toString()];
        var e = -1;
        a && (e = Nb(a, b, c, d));
        return -1 < e ? a[e] : null
    ...
    function K(a, b, c, d, e) {
        if (p(b)) { for (var g = 0; g < b.length; g++) K(a, b[g], c, d, e); return null }
        c = Yb(c);
        if (a && a[Jb]) a = a.V(b, c, d, e);
        else {
    ...
    function $b() {
        var a = bc,
            b = Rb ? function(c) { return a.call(b.src, b.da, c) } : function(c) { c = a.call(b.src, b.da, c); if (!c) return c };
        return b
    }
    ...
    function dc(a) {
        if (r(a) || !a || a.ma) return !1;
        var b = a.src;
        if (b && b[Jb]) return Ob(b.T, a);
        var c = a.type,
            d = a.Ta;
        b.removeEventListener ? b.removeEventListener(c, d, a.Ia) : b.detachEvent && b.detachEvent(ac(c), d);
        Xb--;
        (c = Zb(b)) ? (Ob(c, a), 0 == c.Ea && (c.src = null, b[Vb] = null)) : Mb(a);
        return !0
    }
    ...
    function bc(a, b) {
        ...
        if (!Rb) {
            ...
            if (!(0 > e.keyCode || void 0 != e.returnValue)) {
                a: {
                    var g = !1;
                    if (0 == e.keyCode) try { e.keyCode = -1; break a } catch (h) { g = !0 }
                    if (g || void 0 == e.returnValue) e.returnValue = !0
                }
                e = [];
                for (g = c.currentTarget; g; g = g.parentNode) e.push(g);
                for (var g = a.type, k = e.length - 1; !c.ga && 0 <= k; k--) {
                    c.currentTarget = e[k];
                    var x = ec(e[k], g, !0, c),
                        d = d && x
                }
    ...
    f.dispatchEvent = function(a) {
        ...
        a.ga || (g = a.currentTarget = c, e = hc(g, d, !0, a) && e, a.ga || (e = hc(g, d, !1, a) && e));
        if (b)
            for (h = 0; !a.ga && h < b.length; h++) g = a.currentTarget = b[h], e = hc(g, d, !1, a) && e;
        return e
    };
    f.m = function() {
        L.C.m.call(this);
    ...
    f.send = function(a, b) {
        if (!(a in this.Db)) throw "Sending illegal command " + a;
        var c = {};
        c.chatango_cmd = a;
    ...
    f.td = function(a) {
        a = a.M;
        if (a.data) {
            M.d && this.c.info("onMsg_ " + a.data);
            var b;
            try { b = ma(a.data) } catch (c) { M.d && console.log("Chatango: unexpected msg:" + a.data); return }
    ...
    f.Ud = function() {
        M.d && this.c.info("stopTitle received");
    ...
    function Fc(a, b) {
        var c;
        if (a instanceof Fc) this.v = m(b) ? b : a.v, Gc(this, a.Q), c = a.ha, Q(this), this.ha = c, c = a.G, Q(this), this.G = c, Hc(this, a.fa), c = a.H, Q(this), this.H = c, Ic(this, a.B.clone()), c = a.$, Q(this), this.$ = c;
            ...
            Q(this);
            this.$ = Jc(c)
        } else this.v = !!b, this.B = new Kc(null, 0, this.v)
    }
    f = Fc.prototype;
    f.Q = "";
    f.ha = "";
    ...
    f.toString = function() {
        ...
        if (b = this.H) this.G && "/" != b.charAt(0) && a.push("/"), a.push(Lc(b, "/" == b.charAt(0) ? Nc : Oc, !0));
        (b = this.B.toString()) && a.push("?", b);
        (b = this.$) && a.push("#", Lc(b, Pc));
        return a.join("")
    };
    ...
    f.remove = function(a) {
        R(this);
        a = Sc(this, a);
        return this.g.ta(a) ? (this.s = null, this.k -= this.g.get(a).length, this.g.remove(a)) : !1
    };
    f.clear = function() {
        this.g = this.s = null;
        this.k = 0
    ...
    f.U = function() {
        R(this);
        for (var a = this.g.N(), b = this.g.U(), c = [], d = 0; d < b.length; d++)
    ...
    f.N = function(a) {
        R(this);
        var b = [];
        if (q(a)) this.ta(a) && (b = Sa(b, this.g.get(Sc(this, a))));
        else { a = this.g.N(); for (var c = 0; c < a.length; c++) b = Sa(b, a[c]) }
        return b
    };
    f.set = function(a, b) {
        R(this);
    ...
    f.clone = function() {
        var a = new Kc;
        a.s = this.s;
        this.g && (a.g = this.g.clone(), a.k = this.k);
        return a
    };
    ...
    f.yb = function(a) {
        a && !this.v && (R(this), this.s = null, this.g.forEach(function(a, c) {
            var d = c.toLowerCase();
            c != d && (this.remove(c), this.remove(d), 0 < a.length && (this.s = null, this.g.set(Sc(this, d), Ta(a)), this.k += a.length))
        }, this));
        this.v = a
    };
    ...
    function ad() {
        var a = Zc.i(),
            b = a.u.BASEDOMAIN;
        b || M.d && a.c.info("No manager found for key: BASEDOMAIN");
        return b
    };
    ...
    function id(a) {
        var b = document,
            c = null;
        return (c = b.getElementsByClassName ? b.getElementsByClassName(a)[0] : b.querySelectorAll && b.querySelector ? b.querySelector("." + a) : jd("*", a)[0]) || null
    }
    ...
    function jd(a, b) {
        ...
        if (b && c.getElementsByClassName) {
            ...
            if (d) {
                for (var e = {}, g = 0, h = 0, k; k = c[h]; h++) d == k.nodeName && (e[g++] = k);
                e.length = g;
                return e
            }
            return c
        ...
        if (b) {
            ...
            for (h = g = 0; k = c[h]; h++) {
                var d = k.className,
                    x;
                if (x = "function" == typeof d.split) x = 0 <= Na(d.split(/\s+/), b);
                x && (e[g++] = k)
            }
            e.length = g;
            return e
    ...
    function nd(a) {
        ...
        return z && C("10") && a.pageYOffset != b.scrollTop ? new T(b.scrollLeft, b.scrollTop) : new T(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop)
    }
    ...
    function U(a, b, c) {
        ...
        2 < d.length && od(e, g, d, 2);
        return g
    }

    function od(a, b, c, d) {
        function e(c) { c && b.appendChild(q(c) ? a.createTextNode(c) : c) }
        for (; d < c.length; d++) { var g = c[d];!da(g) || fa(g) && 0 < g.nodeType ? e(g) : Oa(pd(g) ? Ta(g) : g, e) }
    }
    ...
    function Wd(a, b, c) {
        ...
        for (b = 0; b < a.fb.length; b++)
            for (c = a.fb[b].type, d = a.fb[b].rules, e = 0; e < d.length; e++)
                if (g = d[e], M.d && a.c.info("Testing rule: " + na(g)), "undefined" !== typeof g.length) {
                    k = !0;
                    for (h = 0; h < g.length; h++)
                        if (!Xd(a, g[h])) { k = !1; break }
                    if (k) return M.d && a.c.info("Rule matches: " + c), c
                } else if (Xd(a, g)) return M.d && a.c.info("Rule matches"), c;
        M.d && a.c.info("Using default architecture");
        return "js"
    }
    ...
    function Zd(a) {
        var b;
        (b = a.Ib) || (b = {}, $d(a) && (b[0] = !0, b[1] = !0), b = a.Ib = b);
        return b
    };
    var ae;
    ...
    f.send = function(a, b, c, d) {
        ...
        try { X(this.A, Y(this, "Opening Xhr")), this.pb = !0, this.b.open(b, String(a), !0), this.pb = !1 } catch (e) {
            X(this.A, Y(this, "Error opening Xhr: " + e.message));
            je(this, e);
            return
        }
        a = c || "";
    ...
    f.m = function() {
        this.b && (this.l && (this.l = !1, this.aa = !0, this.b.abort(), this.aa = !1), this.ja(!0));
        de.C.m.call(this)
    };
        ...
        if (a.l && "undefined" != typeof aa)
            ...
            try {
                ...
                if (d) a.dispatchEvent("complete"), a.dispatchEvent("success");
                    ...
                    var k;
                    try { k = 2 < Z(a) ? a.b.statusText : "" } catch (x) { X(a.A, "Can not get status: " + x.message), k = "" }
                    a.za = k + " [" + oe(a) + "]";
                    me(a)
                }
            } finally { a.ja() }
    ...
    f.ja = function(a) {
        if (this.b) {
            ...
            try { b.onreadystatechange = c } catch (d) {
    ...
    re.prototype.gb = function() {
        var a = re.C.gb.call(this);
        this.Hb && K(a.upload, "progress", this.dispatchEvent, !1, this);
        return a
    };
    re.prototype.ja = function(a) {
        this.Hb && cc(this.b.upload, "progress", this.dispatchEvent, !1, this);
        re.C.ja.call(this, a)
    };
    ...
    f.V = function(a, b, c, d) {
        ...
        for (var e = 0; e < b.length; e++) {
            var g = K(a, b[e], c || this.handleEvent, d || !1, this.Ma || this);
            if (!g) break;
            this.j[g.key] = g
        }
        return this
    };
    f.zb = function(a, b, c, d, e) {
        if (p(b))
            for (var g = 0; g < b.length; g++) this.zb(a, b[g], c, d, e);
        else c = c || this.handleEvent, e = e || this.Ma || this, c = Yb(c), d = !!d, b = a && a[Jb] ? a.xa(b, c, d, e) : a ? (a = Zb(a)) ? a.xa(b, c, d, e) : null : null, b && (dc(b), delete this.j[b.key]);
        return this
    };
    f.Ba = function() {
        Ua(this.j, dc);
    ...
    f.Ja = function(a) {
        ...
        if (this.Z) {
            this.Z = !1;
            var b = Ae(this, this.deltaX),
                c = Be(this, this.deltaY);
            this.dispatchEvent(new ze("end", this, a.clientX, a.clientY, a, b, c))
    ...
    f.Wc = function(a) {
        if (this.Ub) {
            ...
            this.screenY = a.screenY;
            if (!this.Z) {
                var d = this.Bc - this.clientX,
                    e = this.Cc - this.clientY;
                if (d * d + e * e > this.$b)
    ...
    function De(a, b, c, d) {
        a.Bb && ye(a) ? a.target.style.right = c + "px" : a.target.style.left = c + "px";
    ...
    u(Ge, L);
    n(Ge);
    Ge.prototype.nd = function(a) {
        document.body.style.cursor = this.Mb;
        this.Rb = a.R.screenX;
        this.Sb = a.R.screenY;
    ...
    Ge.prototype.md = function() {
        document.body.style.cursor = "auto";
        He(this, !0);
        localStorage.setItem(this.zc, JSON.stringify({ w: this.la, h: this.ka }))
    };
    Ge.prototype.od = function(a) {
        if (!(0 > a.R.M.x) && 0 != a.R.screenX) {
            switch (this.o) {
                case "tl":
                case "bl":
                    this.la = this.Qb - this.Rb + a.R.screenX;
                    break;
                default:
                    this.la = this.Qb + this.Rb - a.R.screenX
            }
    ...
    function Ie(a, b, c) {
        var d, e, g, h, k = Math.round(a.jb / 2) + 1;
        switch (a.o) {
            case "tl":
                d = b - k;
                g = c - k;
    ...
    f.pd = function(a) {
        var b = a.data.enable;
        b && !this.Wa && (this.Wa = new Ge(this.a, this.f.styles.pos), K(this.Wa, Fd, this.xd, !1, this));
        if (this.Wa)
            if (a = this.Wa, b)
                if (a.K.style.display = "block", b = localStorage.getItem(a.zc), b = JSON.parse(b)) {
                    var c = Ad.i().Fc,
                        b = new S(Math.min(b.w, c.t().width - 20), Math.min(b.h, c.t().height - 20));
                    a.dispatchEvent(new Ed(b));
                    Ie(a, b.width, b.height)
                } else Ie(a, a.a.offsetWidth, a.a.offsetHeight);
    ...
    f.Gd = function() {
        var a = this.f.styles.pos;
        a || (a = this.f.styles.bpos);
        var b, c;
        switch (a) {
            case "tl":
                break;
    ...
    function Oe(a, b) {
        a.W = U("p", void 0, "This version is not available in your current browser.  ");
        var c = U("a", { href: "https://play.google.com/store/apps/details?id=com.android.chrome" }, "Download Chrome for Android");
        qd(a.W, c);
        rd(a.W, b)
    }
    ...
    function Pe(a, b) {
        a.W = U("p", void 0, "This version is not available in your current browser.  ");
        var c = U("a", { href: "https://play.google.com/store/apps/details?id=org.mozilla.firefox" }, "Download Firefox for Android");
        qd(a.W, c);
        rd(a.W, b)
    }
    ...
    function Qe(a, b) {
        a.W = U("p", void 0, "This version is not available in your current browser.  ");
        var c = U("a", { href: "http://google.com/chrome" }, "Download Chrome");
        qd(a.W, c);
        rd(a.W, b)
    }
    ...
    function Le() {
        var a;
        a = jd("script", void 0);
        for (var b = 0; b < a.length; b++) { var c = a[b].id.match(Re); if (c) return a = c[0], b = document, q(a) ? b.getElementById(a) : a }
        return null
    }
    f.vd = function() {
        M.d && this.c.info("onPageShow");
    ...
    function Ue(a) {
        if (a.o)
            if (P.i().ua == uc || 1 >= a.Ga) {
                ...
                a.pa = !1
            } else a.pa = !0, W(a.a, "position", "absolute"), K(window, "scroll", a.Qa, !1, a), Ve(a)
    }
    f.sb = function() {
        if (this.Uc) {
            if (P.i().ua == tc) {
    ...
    f.lc = function() {
        -1 != navigator.userAgent.indexOf("Android") && this.e && this.e.send("keyboarddown");
        this.mc()
    };
    f.Ab = !1;
    ...
    function Se(a) {
        if (a.o) {
            ...
            switch (a.o[1]) {
                case "r":
                    W(a.a, "left", window.scrollX + window.innerWidth - a.width - b + "px");
                    break;
                case "l":
                    W(a.a, "left", window.scrollX - b + "px")
            }
            switch (a.o[0]) {
                case "b":
                    W(a.a, "top", window.scrollY + window.innerHeight - a.height + 1 + "px");
                    break;
                case "t":
